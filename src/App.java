...
public class App {
    ...
    Maps maps = new Maps();
     ...
     //Implementación -> HasSet hashcode
     ...
     System.out.println(hashSet.contains("F"));
      ...
      //Implementación -> LinkedHashSet hashcode
     System.out.println("----------LinkedHashSet:----------");
     Set<String> lSet = sets.construirLiskedHashSet();
     System.out.println(lSet);
     System.out.println("Size = " + lSet.size());
     System.out.println(lSet.contains("F"));

    //Implementación -> TreeSet hashcode
    ...
    //Implementación -> HashSetContacto hashcode
    ...
    System.out.println(hCSet.contains("F"));
     ...
     //Implementación -> TreeSetContacto hashcode
    ...
    System.out.println(mapa.containsKey("A"));
    }
  }
